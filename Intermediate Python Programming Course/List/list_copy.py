# Warning:- We should't name a list by list. its a keyword for passing argument


list1 = ["banana", "apple", "mango", "grapes", "orange", "kiwi"]
list_cpy = []
...
# -----------------------------------#
""" assigning another list value straight away doesn't makes new list
    It copies the memory address of the assigned list.
    So whenever we change or update the new list value it changes the original lists/assigned lists value
"""
# list_cpy= list
# print(list_cpy)
# list_cpy[0] = "kola"
...
# list_cpy = list1.copy()
# list_cpy= list(list1)
# list_cpy = list1[:] # [:] returns every value of the list
# list_cpy[0]= "kola"
# print(list1)
# print(list_cpy)
# -----------------------------------#
